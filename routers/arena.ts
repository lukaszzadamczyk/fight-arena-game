...
arenaRouter
    ...
    .post('/fight',async (req,res) => {
        ...
        if (warrior1Id === warrior2Id){
            throw new ValidationError(`Please choose two different opponents.`);
        }
        ...
        if (!warrior1) {
            throw new ValidationError(`opponent number 1 was not found.`);
        }
        if (!warrior2) {
            throw new ValidationError(`opponent number 2 was not found.`);
        }
